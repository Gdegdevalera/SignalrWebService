...
namespace SignalrWebService.Performance
{
    ...
    {
        private readonly IHubContext _hubs;
        ...
        public PerformanceEngine(int pollIntervalMillis, IConnectionManager connectionManager)
        {
            //HostingEnvironment.RegisterObject(this);
            _hubs = connectionManager.GetHubContext<PerformanceHub>();
	    ...
	    public static PerformanceHub Hub { get; set; }
